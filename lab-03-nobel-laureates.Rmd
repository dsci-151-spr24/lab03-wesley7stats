...
**There are `r nrow(nobel)` and `r ncol(nobel)`columns in the nobel dataset. Each row represnts a nobel winner.**
...
***yes, the visualation supports the claim that there are more US born than others born Nobel laureates. There are more US(123) but also other Nobel laureates at (105).***
...
```
***Germany is the most common with 20 followed closely by Japen and UK.***
